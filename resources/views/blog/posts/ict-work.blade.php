<x-layout.main>
    <x-slot name="title">ICT field of work</x-slot>
<h1 id="ict-header">ICT field of work</h1>
<!--the main content of the pae-->
<main class="ict-main">
    <h3 id="ict-subheader">What are the most interesting companies for me?</h3>
    <p>
    ...
    <p id="info-ict-para">
        Facebook is a social media and social networking service owned by American technology conglomerate Meta. Created
        in 2004 by Mark Zuckerberg with four other Harvard College students and roommates Eduardo Saverin, Andrew
        McCollum, Dustin Moskovitz, and Chris Hughes, its name derives from the face book directories often given to
        American university students. Membership was initially limited to Harvard students, gradually expanding to other
        North American universities. Since 2006, Facebook allows everyone to register from 13 years old, except in the
        case of a handful of nations, where the age limit is 14 years. As of December 2022, Facebook claimed almost 3
        billion monthly active users. As of October 2023, Facebook ranked as the third-most-visited website in the
    ...
    <p>
        ...
        everything about them is quite interesting to see how it is done. The other reason that I would like to work in
        the company would be that it could give me a lot of marketing and coding experience. Another opportunity that I
        would add is that I can improve the system as well and be a part of that large team. Also, I'd like to see how all
        the information about all the users has been used and where exactly it goes.
    <ul>
    ...
    <p id="info-ict-para">
        YouTube is an American online video sharing platform owned by Google. Accessible worldwide, YouTube was
        launched on February 14, 2005, by Steve Chen, Chad Hurley, and Jawed Karim, three former employees of PayPal.
        Headquartered in San Bruno, California, United States, it is the second-most visited website in the world, after
        Google Search. In January 2024, YouTube had more than 2.7 billion monthly active users, who collectively watched
        more than one billion hours of videos every day. As of May 2019, videos were being uploaded to the platform at
        a rate of more than 500 hours of content per minute, and as of 2021, there were approximately 14 billion
        videos in total.
    </p>
    <p>
    ...
    <p id="info-ict-para">
        ...
        brought innovation and a new generation of listeners to the medium, and in 2022 we entered the next audio market
        primed for growth with the addition of audiobooks.
    </p>
    <p id="info-ict-para">
        Today, more listeners than ever can discover, manage and enjoy more than 100 million tracks, 6 million podcasts
    ...
    <ul>
        <li>Sources: Spotify Company Information - Official Website</li>
    </ul>
    </p>
